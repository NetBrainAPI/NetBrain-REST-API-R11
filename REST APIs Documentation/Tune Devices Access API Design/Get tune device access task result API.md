...
|status	|int	|Status code. Unknown = 0,<br>Scheduled = 1, <br>Started = 2, <br>Running = 3, <br>CompletedNormally = 4, <br>CompletedWithException = 5, <br>CompletedCrash = 6, <br>Canceled = 7|
